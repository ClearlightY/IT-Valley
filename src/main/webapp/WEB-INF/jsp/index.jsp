...
<head>
    <title>IT Valley - 专业IT技术社区</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 hidden-sm hidden-xs">
                                ...
                                <tr>
                                    <c:if test="${fn:length(item.avatar) > 0}">
                                        <td width="24" valign="middle" align="center">
                                            <%-- <a href="/user/${item.author}"> --%><img src="${item.avatar}"
                                                class="avatar img-circle" border="0" align="default"
              ...
              <table class="table" style="font-size: 14px;">
                ...
                <!-- 积分榜 -->
                <div class="panel panel-default">
                    <div class="panel-heading"><span style="color: #ccc;">积分榜 <a class="dark" href="/top100">TOP 100
                                &gt;&gt;</a></span>
                    </div>
            ...
            <div class="panel-body">
              ...
              <c:forEach var="item" items="${nodeList2}">
                  <div class="col-md-6" style="margin-bottom: 10px; padding-left: 10px;">
                    &lt;%&ndash; <a href="${item.url}">
                      <span>n/${item.nodeTitle}</span>
                    </a> &ndash;%&gt;
                    &lt;%&ndash; <span class="text-muted">x ${item.number}</span> &ndash;%&gt;
                ...
                <!-- 社区运行状况 -->
                <div class="panel panel-default">
                    <div class="panel-heading"><span style="color: #ccc;">论坛运行状况</span></div>
                    <div class="cell">
                        <table cellpadding="5" cellspacing="0" border="0" width="100%">
                            <tbody style="font-size: 14px;">
                                ...
                                <tr>
                                    <td width="80" align="right" style="font-size: 14px;"><span class="gray">主题：</span>
                                    </td>
