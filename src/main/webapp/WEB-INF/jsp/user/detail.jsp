                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="auto" valign="top" align="left">
                                        ...
                                        <!-- <span class="gray" style="font-size: 14px;">邮&nbsp;&nbsp;箱：<a href="${user.email}">${user.email}</a>
                </span><br/>
                <span class="gray" style="font-size: 14px;">个人网站：${user.url}
                </span><br/>
                <span class="gray" style="font-size: 14px;">Github&nbsp;：${user.thirdId}
                </span> -->
                                        <c:if test="${user.url !=null}">
                                        <span class="links-of-author-item"><a href="https://${user.url}" target="_blank"
                                                title="website"><i class="fa fa-globe fa-fw"></i>Website</a> </span>
                                        </c:if>
